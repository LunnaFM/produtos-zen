...
export default function Portfolio() {
  ...
  const products = [
    ...
    {
      src: "./public/images/eucalipto.PNG",
    ...
    {
      src: "./public/images/bergamota.PNG",
